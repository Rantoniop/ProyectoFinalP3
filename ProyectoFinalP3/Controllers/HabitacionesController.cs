...
namespace ProyectoFinalP3.Controllers
{
    public class HabitacionesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Numero,Tipo,PrecioPorDia")] Habitaciones habitaciones)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Numero,Tipo,PrecioPorDia")] Habitaciones habitaciones)
        {
            if (ModelState.IsValid)
            {
